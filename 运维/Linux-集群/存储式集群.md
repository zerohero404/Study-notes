...
&ensp;&ensp;&ensp;&ensp;chmod a+x /usr/local/mfs/sbin/* # 优化配置，使 MFS 命令便于调用<br>
&ensp;&ensp;&ensp;&ensp;ln -s /usr/local/mfs/sbin/* /usr/local/sbin/<br>
&ensp;&ensp;&ensp;&ensp;ln -s /usr/local/mfs/bin/* /usr/local/bin/<br>
&ensp;&ensp;&ensp;&ensp;mkdir /mnt/mfsclient # 建立 MFS 服务集群文件挂载点<br>
&ensp;&ensp;&ensp;&ensp;mfsmount /mnt/mfsclient/ -H 10.10.10.11（MFS 管理服务器 IP 地址）<br>
&ensp;&ensp;&ensp;&ensp;chown -R mfs:mfs /mnt/mfsclient/<br>
&ensp;&ensp;&ensp;&ensp;cd /mnt/mfsclient/ && touch 1.txt && echo “abcd” >> 1.txt # 模拟写入数据<br>
&ensp;&ensp;&ensp;&ensp;mfsfileinfo 1.txt # 查看数据的具体信息以及存放位置<br>
